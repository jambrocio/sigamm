...
public class FacturacionDaoImpl implements FacturacionDao {
	...
	public Retorno grabarFacturacionDetalle(FacturacionDetalle facturacion, int codigoFacturacion) {
		...
		try{
			...
			parametros.addValue("vi_codigo_servicio_detalle", 	facturacion.getCodigoServicioDetalle());
	...
	public Retorno grabarServicios(ServiciosDetalle servicios) {
		...
		try{
			...
			jdbcCall.withProcedureName("SP_GRABAR_SERVICIO").declareParameters(
				...
				new SqlParameter("vi_flag_importe_variable", 	Types.INTEGER),
				new SqlParameter("vi_flag_generar_cobro", 		Types.INTEGER),
			...
			parametros.addValue("vi_flag_importe_variable",		servicios.getFlagImporteVariable());
			parametros.addValue("vi_flag_generar_cobro",		servicios.getFlagGenerarCobro());
			parametros.addValue("vi_periodo",					servicios.getPeriodo());
