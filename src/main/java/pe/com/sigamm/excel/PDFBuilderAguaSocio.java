...
public class PDFBuilderAguaSocio extends AbstractPdfView{
    ...
    private static final Logger log = Logger.getLogger(PDFBuilderAguaSocio.class);
	...
	protected void buildPdfDocument(        
        ...
        ReciboAguaSocio reciboAguaSocio = (ReciboAguaSocio) model.get("reciboAguaSocio");
        
        writer = PdfWriter.getInstance(document, new FileOutputStream("ReciboAguaSocio.pdf"));
        /*
