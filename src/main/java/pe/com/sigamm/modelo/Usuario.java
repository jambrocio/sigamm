...
public class Usuario {
	...
	public String getListaImei() {
		return listaImei;
	}
	public void setListaImei(String listaImei) {
		this.listaImei = listaImei;
	}
	...
	public int getExisteVoto() {
		return existeVoto;
	}
	public void setExisteVoto(int existeVoto) {
		this.existeVoto = existeVoto;
	}
