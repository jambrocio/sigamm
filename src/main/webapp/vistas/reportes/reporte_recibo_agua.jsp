...
function openNewWindowForJasperWithCharts(){
	...
	var url  = "/sigamm/recibosAgua?fechaInicial="+fechaInicial+"&estado="+estado;
		...
		<tr>
			<td>
				<div class="panel panel-primary">
					<div class="panel-heading">Reporte Recibo de Agua de los Asociados</div>
					<div class="panel-body">
					<form style="margin-top: 1.0em;" method="get">
						<table border="0" cellpadding="5">
							<tr>
								<td rowspan="4">
									<img src="recursos/images/reciboAgua.png" border="0" />
								</td>
							</tr>
							<tr>
								<td width="30px">&nbsp;</td>
