...
--------------------------------------------------------
   ...
   CREATE SEQUENCE  "JAMBROCIO"."SEQ_SIS_SOCIO"  MINVALUE 1 MAXVALUE 9999999999999999999999999 INCREMENT BY 1 START WITH 1 CACHE 20 NOORDER  NOCYCLE ;
--------------------------------------------------------
...
SET DEFINE OFF;
Insert into JAMBROCIO.SIS_SERVICIO (CODIGO_SERVICIO,NOMBRE_SERVICIO,ESTADO) values ('1','VIGILANCIA','1');
Insert into JAMBROCIO.SIS_SERVICIO (CODIGO_SERVICIO,NOMBRE_SERVICIO,ESTADO) values ('2','AGUA','1');
Insert into JAMBROCIO.SIS_SERVICIO (CODIGO_SERVICIO,NOMBRE_SERVICIO,ESTADO) values ('3','LUZ','1');
REM INSERTING into JAMBROCIO.SIS_SERVICIO_DETALLE
SET DEFINE OFF;
Insert into JAMBROCIO.SIS_SERVICIO_DETALLE (CODIGO_SERVICIO_DETALLE,NOMBRE_DETALLE,IMPORTE,ESTADO,CODIGO_SERVICIO,OBLIGATORIO) values ('1','VIGILANCIA','0,5','1','1','1');
Insert into JAMBROCIO.SIS_SERVICIO_DETALLE (CODIGO_SERVICIO_DETALLE,NOMBRE_DETALLE,IMPORTE,ESTADO,CODIGO_SERVICIO,OBLIGATORIO) values ('2','AGUA','0','1','2','0');
Insert into JAMBROCIO.SIS_SERVICIO_DETALLE (CODIGO_SERVICIO_DETALLE,NOMBRE_DETALLE,IMPORTE,ESTADO,CODIGO_SERVICIO,OBLIGATORIO) values ('3','ALCANTARILLADO','2','1','2','0');
Insert into JAMBROCIO.SIS_SERVICIO_DETALLE (CODIGO_SERVICIO_DETALLE,NOMBRE_DETALLE,IMPORTE,ESTADO,CODIGO_SERVICIO,OBLIGATORIO) values ('4','LUZ','0','1','3','0');
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "JAMBROCIO"."SIS_SOCIO_PK" ON "JAMBROCIO"."SIS_SOCIO" ("CODIGO_SOCIO", "DNI", "NRO_PUESTO") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM" ;
...
--------------------------------------------------------
  ...
  ALTER TABLE "JAMBROCIO"."SIS_SOCIO" ADD CONSTRAINT "SIS_SOCIO_PK" PRIMARY KEY ("CODIGO_SOCIO", "DNI", "NRO_PUESTO")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM"  ENABLE;
...
--------------------------------------------------------
  ...
  BEGIN
    ...
    IF vi_dni = '0' THEN
        ...
        OPEN vo_result FOR
            SELECT codigo_socio, nro_puesto, codigo_giro, dni, nombre_full, nombre_giro
            FROM (
                SELECT codigo_socio, nro_puesto, codigo_giro, dni, nombre_full, nombre_giro, ROWNUM numfila
                FROM (
                
                      SELECT s.codigo_socio, s.nro_puesto, s.codigo_giro, s.dni, s.apellido_paterno || ' ' || s.apellido_materno || ', ' || s.nombres AS nombre_full, g.nombre_giro
                      FROM sis_socio s
                      LEFT JOIN sis_giro_comercial g ON s.codigo_giro = g.codigo_giro
