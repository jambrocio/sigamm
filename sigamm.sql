...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FUNCTION "SIGAMM"."CUSTOM_AUTH" (p_username in VARCHAR2, p_password in VARCHAR2)
return BOOLEAN
is
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FUNCTION "SIGAMM"."CUSTOM_HASH" (p_username in varchar2, p_password in varchar2)
return varchar2
is
  l_password varchar2(4000);
  l_salt varchar2(4000) := 'YUF4789J4EP9IV3EXRU4ZM2VUHX6HR';
begin
